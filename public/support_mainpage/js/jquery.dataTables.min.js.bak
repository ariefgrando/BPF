	...
	var N = function (h) {
		...
		function Da(a) {
			var b = a.aoColumns,
				...
				e, f, g, j, i, h, m, o, k;
			e = 0;
			for (f = b.length; e < f; e++) if (m = b[e], k = [], !m.sType && m._sManualType) m.sType = m._sManualType;
			else if (!m.sType) {
				g = 0;
		...
		function hb(a, b, c, d) {
			...
			if (b) for (e = b.length - 1; 0 <= e; e--) {
				...
				for (g = o.length; f < g; f++) if ("number" === typeof o[f] && 0 <= o[f]) {
					...
					d(o[f], n)
				} else if ("number" === typeof o[f] && 0 > o[f]) d(m.length + o[f], n);
		...
		function la(a, b, c, d) {
			var e = a.aoData[b],
				f;
			if ("dom" === c || (!c || "auto" === c) && "dom" === e.src) e._aData = ia(a, e).data;
			else {
				var g = e.anCells,
					j;
				if (g) {
		...
		function ib(a) {
			...
			i && (e = h("<tr/>").appendTo(g));
			b = 0;
			for (c = m.length; b < c; b++) f = m[b], d = h(f.nTh).addClass(f.sClass), i && d.appendTo(e), a.oFeatures.bSort && (d.addClass(f.sSortingClass), !1 !== f.bSortable && (d.attr("tabindex", a.iTabIndex).attr("aria-controls", a.sTableId), Ka(a, f.nTh, b))), f.sTitle != d.html() && d.html(f.sTitle), La(a, "header")(a, d, f, n);
			i && aa(a.aoHeader, g);
		...
		function K(a) {
			...
			if (-1 !== h.inArray(!1, b)) B(a, !1);
				...
				u(a, "aoFooterCallback", "footer", [h(a.nTFoot).children("tr")[0], Ha(a), g, n, i]);
				d = h(a.nTBody);
				d.children().detach();
				d.append(h(b));
		...
		function lb(a) {
			...
			for (var f = a.sDom.split(""), g, j, i, n, m, o, k = 0; k < f.length; k++) {
				...
				else if ("l" == j && d.bPaginate && d.bLengthChange) g = mb(a);
			...
			for (i = c.length; f < i; f++) {
				...
				for (e = d.firstChild; e;) {
					if ("TD" == e.nodeName.toUpperCase() || "TH" == e.nodeName.toUpperCase()) {
						...
						n = g;
						k = 1 === m ? !0 : !1;
						for (j = 0; j < m; j++) for (g = 0; g < o; g++) a[f + g][n + j] = {
							cell: e,
							unique: k
						}, a[f + g].nTr = d
					}
		...
		function mb(a) {
			for (
			var b = a.oClasses, c = a.sTableId, d = a.aLengthMenu, e = h.isArray(d[0]), f = e ? d[0] : d, d = e ? d[1] : d, e = h("<select/>", {
				name: c + "_length",
				"aria-controls": c,
		...
		function pb(a) {
			...
			}).append(n.removeAttr("id").css("margin-left", 0).append(b.children("tfoot")))).append("bottom" === j ? g : null));
			var b = c.children(),
				o = b[0],
				f = b[1],
				k = m ? b[2] : null;
		...
		function W(a) {
			...
			if (q.outerWidth() < g) {
				...
				if (v && (i.scrollHeight > i.offsetHeight || "scroll" == o.css("overflow-y"))) M.width = s(t - f);
		...
		function Ca(a) {
			var b = a.nTable,
				...
				o = !1,
				k, l;
			for (k = 0; k < d.length; k++) l = c[d[k]], null !== l.sWidth && (l.sWidth = Cb(l.sWidthOrig, m), o = !0);
			if (!o && !f && !e && j == Z(a) && j == i.length) for (k = 0; k < j; k++) c[k].sWidth = s(i.eq(k).width());
			else {
		...
		function P(a, b, c, d) {
			...
			if (b) za.console && console.log && console.log(c);
		...
		var p, t, q, r, v, Wa = {},
			...
			C = function (a, b, c) {
				var d = [],
					e = 0,
					f = a.length;
				if (c !== l) for (; e < f; e++) a[e] && a[e][b] && d.push(a[e][b][c]);
			...
			xa = function (a, b, c, d) {
				var e = [],
					f = 0,
					g = b.length;
				if (d !== l) for (; f < g; f++) e.push(a[b[f]][c][d]);
		...
		p = function (a) {
			...
			this.each(function () {
				...
				if ("table" != this.nodeName.toLowerCase()) P(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
					...
					if (g.aaData) for (j = 0; j < g.aaData.length; j++) I(k, g.aaData[j]);
		...
		q.prototype = {
			...
			iterator: function (a, b, c) {
				...
				f = 0;
				for (g = n.length; f < g; f++) if ("table" === b) e = c(n[f], f), e !== l && d.push(e);
		...
		q.register = r = function (a, b) {
			if (h.isArray(a)) for (var c = 0, d = a.length; c < d; c++) q.register(a[c], b);
		...
		r("row().child()", function (a, b) {
			...
			if (!0 === a) this.child.show();
				...
				if (h.isArray(a) || a instanceof h) for (var g = 0, j = a.length; g < j; g++) f(a[g], b);
				else f(a, b);
